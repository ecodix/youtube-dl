...
class FranceTVInfoIE(FranceTVBaseInfoExtractor):
    ...
    _VALID_URL = r'https?://(?:www|mobile|france3-regions|la1ere)\.francetvinfo\.fr/(?:[^/]+/)*(?P<id>[^/?#&.]+)' '''Suggestion added a root URL to add all french overseas s content, solving issue 32713''' 
